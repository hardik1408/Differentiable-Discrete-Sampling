...
from utils_scat import my_softmax, get_offdiag_indices, gumbel_softmax, custom_categorical
        ...
        for step in range(0, inputs.size(1) - 1):
            ...
            if dynamic_graph and step >= burn_in_steps:
                logits = encoder(
                    ...
                    rel_rec, rel_send)
                # Replace gumbel_softmax with custom estimator:
                prob_dyn = my_softmax(logits, -1)
                rel_type = custom_categorical(prob_dyn)
